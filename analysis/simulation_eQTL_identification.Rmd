---
title: "Simulation: Identifying dynamic eQTLs using FASH"
author: "Ziang Zhang"
date: "2024-05-19"
...
```{r}
sizeB <- 200
data_sim_list_B <- lapply(1:sizeB, function(i) simulate_process(sd_poly = 1, type = "linear", sd = sigma[i + sizeA]))
par(mfrow = c(2, 2))
for (i in 1:4) {
