...
We assign each true concentration function an independent prior, which is a finite mixture of second order IWP with different $\sigma_k$. So \[f_i |\pi_0,..,\pi_K \overset{d}{=} \sum_{k=0}^K \pi_kg_k,\] where each mixture component $g_k$ is defined as \[\frac{\partial^2}{\partial x^2}g(x) = \sigma_k W(x).\]
