...
where $W(x)$ is the Gaussian white noise process, $L = \frac{\partial^3}{\partial x^3}$ and $\sigma_k$ is the smoothness parameter that inversely controls the shrinkage strength. 
