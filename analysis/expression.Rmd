...
colnames(gene_set_table) <- trimws(colnames(gene_set_table))

# View the loaded table
print(gene_set_table)
...
gene_set_table$Gene.cluster.6 <- as.numeric(gene_set_table$Gene.cluster.6)
gene_set_table$Gene.cluster.9 <- as.numeric(gene_set_table$Gene.cluster.9)
