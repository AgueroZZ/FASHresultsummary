...
$$f_i(t) = \sum_{k=1}^K \pi_k g_k(t).$$
Each mixture component $g_k$ has the prior: $$Lg_k(t) = \sigma_k W(t), $$ with $W(t)$ being a Gaussian white noise process and $\sigma_k$ being the smoothness. 
The base model that each $f_i$ being shrunk to is therefore $\text{Null}\{L\} = \text{span}\{1,t\}$.
