...
The estimated $\pi_0$ is `r fash_fit2$prior_weights$prior_weight[1]`, which is way too small to be realistic.
...
The MOM estimate is `r pio_mom_2`, which is much smaller than the estimated $\pi_0$ from the model.
...
The conservative estimate is `r fash_fit2_update$prior_weights$prior_weight[1]`, which is much more realistic.
